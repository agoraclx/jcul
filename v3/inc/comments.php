    ...
    <div id="comment-<?php comment_ID(); ?>" class="comment-inner">
      ...
      <div class="commentmeta">
        ...
        <span class="authorname">
          <?php echo agora_time_diff(get_comment_time('U'), current_time('timestamp')).' yang lalu'; ?>
      ...
      <div class="comment-text">
        <?php if($comment->comment_approved == '0') : ?>
          <em class="awaiting_moderation"><?php _e('Komentar Jculers masih di moderasi.', THB_THEME_NAME) ?></em>
          <?php
        endif;
        comment_text();
        comment_reply_link(array_merge($args, array('reply_text' => __('<i class="icon-mail-reply"></i> Reply', THB_THEME_NAME), 'depth' => $depth, 'max_depth' => $args['max_depth'])));
        ?>
      </div>
