<?php
if(false === ( $single_special_query_results = get_transient('single_special_query_results') ))
{
$randargs              = array (
'orderby'     => 'rand',
'posts_per_page' => 100
);
$single_special_query_results = get_posts($randargs);

set_transient('single_special_query_results', $single_special_query_results, 60*60*12);
}
$randomposts = get_transient('single_special_query_results');
$randkey     = array_rand($randomposts, 68 );
